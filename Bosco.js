...
module.exports = bosco = async (bosco, mek) => {
	try {
       ...
       const catlo = (teks) => {
        ...
        const grupinv = (teks) => {
        	grup = bosco.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'ʜʏ ᴅᴜᴅᴇ..💘', "groupName": `Bosco Family`, "footerText": "*Britto Ser*", "jpegThumbnail": dfrply, "caption": teks}}, {quoted:fvideo})
        ...
        const reply = (teks) => {
	      bosco.sendMessage(from, teks, text, { thumbnail: denis, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: false, "externalAdReply": { "title": `${' '}✰ɪᴛsᴍᴇ ᴥ︎︎︎ ʙᴇʟᴄᴏ♕︎✔︎${''}${''}`, "body": `ɢʀᴏᴜᴘ ᴀssɪsᴛᴇɴᴛ ʙᴏᴛ`, "previewType": 'PHOTO', "thumbnailUrl": `${''}`, "thumbnail": denis, "sourceUrl": `${''}`}},})
        }
...
// AUTO
			...
			for (let anjh of imagi){
				if (budy === anjh){
					...
					bosco.sendMessage(from, result, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 500, status: 200, thumbnail: fs.readFileSync('./ds.jpg'), surface: 200, message: `${fake}`, orderTitle: `MADE BY Britto`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
      ...
      const sendWebp = async(to, url) => {
       ...
       const sendMediaURL = async(to, url, text="", mids=[]) =>{
           ...
           bosco.sendMessage(to, media, type, {quoted: mek, "externalAdReply": { "title": `${' '}✰ɪᴛsᴍᴇ ᴥ︎︎︎ ʙᴇʟᴄᴏ♕︎✔︎${''}${''}`, "body": `Gʀᴏᴜᴘ Assɪsᴛᴇɴᴛ Bᴏᴛ`, "previewType": 'PHOTO', "thumbnailUrl": `${''}`, "thumbnail": denis, "sourceUrl": `${''}`}, mimetype: mime, caption: text, thumbnail: Buffer.alloc(0), contextInfo: {"mentionedJid": mids}})
...
☞︎︎︎ 𝙳𝙾𝙽𝚃 𝙼𝙸𝚂𝚄𝚂𝙴 𝚃𝙷𝙴 𝙱𝙾𝚃

☞︎︎︎ 𝙰𝙽𝚈 𝙿𝚁𝙾𝙱𝙻𝙰𝙼 𝙲𝙾𝙽𝚃𝙰𝙲𝚃 𝙾𝚄𝚁 𝙾𝚆𝙽𝙴𝚁

☞︎︎︎ ᴅᴏɴᴛ ᴀsᴋ ʙᴏᴛ ғɪʟᴇ...
     ...
     case 'seenby':
      ...
      case 'hidetag':
       ...
       case 'denis':
              if (!q) return
              qq = q.toUpperCase()
              awikwok = `${qq} ${qq} ${qq} ❤️ ❤️ ❤️ WANGY WANGY WANGY WANGY HU HA HU HA HU HA, Britto Poli Ahn ${qq} Britto Killadi Ahnu ${qq} AAAAAAAAH ~ Rambutnya.... aaah rambutnya juga pengen aku elus-elus ~~ AAAAAH ${qq} keluar pertama kali di anime juga manis ❤️ ❤️ ❤️ banget AAAAAAAAH ${qq} AAAAA LUCCUUUUUUUUUUUUUUU............ ${qq} AAAAAAAAAAAAAAAAAAAAGH ❤️ ❤️ ❤️apa ? ${qq} itu gak nyata ? Cuma HALU katamu ? nggak, ngak ngak ngak ngak NGAAAAAAAAK GUA GAK PERCAYA ITU DIA NYATA NGAAAAAAAAAAAAAAAAAK PEDULI BANGSAAAAAT !! GUA GAK PEDULI SAMA KENYATAAN POKOKNYA GAK PEDULI. ❤️ ❤️ ❤️ ${qq} gw ... ${qq} di laptop ngeliatin gw, ${qq} .. kamu percaya sama aku ? aaaaaaaaaaah syukur ${q} aku gak mau merelakan ${qq} aaaaaah ❤️ ❤️ ❤️ YEAAAAAAAAAAAH GUA MASIH PUNYA ${qq} SENDIRI PUN NGGAK SAMA AAAAAAAAAAAAAAH`
              reply(awikwok)
              break
        case 'jadibot':
              if (!isOwner) return
...
*ɴᴀᴍᴇ* : ${i.name}
*ᴅᴇᴠɪsᴇ* : ${i.phone.device_manufacturer}
*ᴍᴏᴅᴇʟ* : ${i.phone.device_model}\n\n`
}
            reply(text)
            break
...
*▢ 𝙿𝚁𝙸𝚂𝙴 : ${get_result[i].price}*
*▢ 𝚁𝙰𝚃𝙴 : ${get_result[i].rating}*
*▢ 𝙻𝙸𝙽𝙺 : ${get_result[i].url}*
...
*🎗️ ɪ ᴀᴍ sᴛɪʟʟ ᴀʟɪᴠᴇ ʙʀᴏ :)*
*🎗️ sᴘᴇᴇᴅ :* ${latensie.toFixed(4)} Second
*🎗️ ᴜsᴀɢᴇ :* ${ram2}
*🎗️ ʙᴀᴛᴛᴇʀʏ :* ${baterai}% ${charger}
*🎗️ ᴘʟᴀᴛғᴏʀᴍ :* ${os.platform()}
*🎗️ ᴜᴘᴛɪᴍᴇ :* ${runtime(process.uptime())}

✩ *𝙸𝙽𝙵𝙾* ☆

*🎗️ ᴡᴀ ᴠᴇʀsɪᴏɴ :* ${bosco.user.phone.wa_version}
*🎗️ ᴏs ᴠᴇʀsɪᴏɴ :* ${bosco.user.phone.os_version}
*🎗️ ᴅᴇᴠɪᴄᴇ :* I PHONE 13 PRO
*🎗️ ᴅᴇᴠɪᴄᴇ ᴍᴏᴅᴇʟ :* 13 PRO MAX
`
    menubutton = [{buttonId:`${prefix}owner`,buttonText:{displayText:'ɴɪᴄᴇ👻'},type:1}
]
 menumessage = { contentText: `${teks}`, footerText: `ᴇᴅɪᴛᴇᴅ ʙʏ ʙᴇʟᴄᴏ`, buttons: menubutton, headerType: 6, locationMessage: bosco2.message.locationMessage}
 ...
 //------------------< Extra >-------------------
      ...
      case 'tod':
        ...
        case 'anime':
              ...
              imageMsg = ( await bosco.prepareMessage(from, fs.readFileSync(`./${sender}.jpeg`), 'imageMessage', {thumbnail: Buffer.alloc(0)})).message.imageMessage
              buttonsMessage = {footerText:'© 𝒎𝒂𝒅𝒆 𝒃𝒚 𝒃𝒓𝒊𝒕𝒕𝒐', imageMessage: imageMsg,
...
📜 ᴛɪᴛʟᴇ ♫︎ : ${res.all[0].title}
🎁 ᴛʏᴘᴇ : mp3
📬 ɪᴅ : ${res.all[0].videoId}
🌐 ᴘᴜʙʟɪᴄᴀᴛɪᴏɴ : ${res.all[0].ago}
🎞️ ᴡᴀᴛᴄʜᴇᴅ : ${res.all[0].views}
⚖️ ᴅᴜʀᴀᴛɪᴏɴ : ${res.all[0].timestamp}
🎥 ᴄʜᴀɴɴᴇʟ : ${res.all[0].author.name}
🖇️ ʟɪɴᴋ : ${res.all[0].author.url}
...
//------------------< Storage >-------------------
	 ...
	 case 'delvn':
				...
				case 'listbgm':
					...
					teks += `\n*ᴛᴏᴛᴀʟ : ${vien.length}*\n\n_🦋_`
					bosco.sendMessage(from, teks.trim(), extendedText, { caption: 'teks', "contextInfo": { text: 'teks', sendEphemeral: true, "externalAdReply": { "title": `${' '}✰ɪᴛsᴍᴇᴥ︎︎︎ʙᴇʟᴄᴏ♕︎✔︎${''}${''}`, "body": ``, "previewType": 'PHOTO', "thumbnailUrl": `${'https://i.ibb.co/vkkcm0L/034c588fd8d5.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://wa.me/c/919567941560'}`}},quoted: ftext})
					break
				case 'addimage':
